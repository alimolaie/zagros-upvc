...
var options2 = {
    ...
    xaxis: {
        categories: ['کره', 'کانادا', 'آمریکا', 'هلند', 'ایران', 'فرانسه', 'ترکیه', 'ژاپن', 'چین', 'آلمان'],
    },
    colors:['#7e37d8']
}
...
var options = {
    ...
    series: [{
        name: 'محصول 1',
        data: generateData(new Date('11 مهر 2017 GMT').getTime(), 20, {
            min: 10,
            max: 60
        })
    },
...
var options10 = {
    ...
    labels: ['شنبه', 'یکشنبه', 'دوشنبه', 'سه شنبه', 'چهارشنبهه', 'پنجشنبه', 'جعمه'],
    plotOptions: {
        radar: {
            size: 140,
            polygons: {
