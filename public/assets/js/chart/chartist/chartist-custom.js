(function($) {
	...
	var data = {
	  	labels: ['هفته1', 'هفته2', 'هفته3', 'هفته4', 'هفته5', 'هفته6', 'هفته7', 'هفته8', 'هفته9', 'هفته10'],
	  	series: [
			[1, 2, 4, 8, 6, -2, -1, -4, -6, -2]
	  	]
	};
	...
	new Chartist.Bar('.ct-11', {
	  	labels: ['شنبه', 'یکشنبه', 'دوشنبه', 'سه شنبه', 'چهارشنبه', 'پنجشنبه', 'جعمه'],
	  	series: [
			[5, 4, 3, 7, 5, 10, 3],
			[3, 2, 9, 5, 4, 6, 4]
	  	]
	...
	new Chartist.Bar('.ct-12', {
	  	labels: ['1390-11', '1391-12', '1392-13', '1393-13', '1394-15', '1395-16', '1396-17', '1397-18'],
	  	series: [
