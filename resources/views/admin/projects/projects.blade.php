                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col">نوع شیشه </th>
                                        <th scope="col">نوع پروفیل </th>
                                    ...
                                    @foreach ($projects as $row)
                                        ...
                                        <tr>
                                            ...
                                            <td> {{$row->full_name}} </td>
                                            <td> {{$row->mobile}} </td>
                                            <td> {{$row->nationality_code}} </td>
                                            <td> {{$row->glass->title_glass}} </td>
                                            <td> {{$row->profile->title_profile}} </td>
                                            <td> {{$row->brand->title_brand}} </td>
                                            <td> {{$row->address}} </td>
                                            <td> {{verta($row->created_at)->format('%B %d، %Y H:i')}} </td>
                                            <td>

                                                <button type="submit" style="border:0 solid black; background-color: transparent;" class="remove-service" data-action="{{route('project.delete',$row->id)}}"><i class="fa fa-trash-o text-danger" aria-hidden="true"></i></button>
...
<script type="text/javascript">
    $("body").on("click", ".remove-service", function () {
        ...
        swal({
            ...
            text: "آیا میخواهید این زیر پروژه رو حذف کنید",
            type: "error",
