                ...
                <div class="page-header">
                    <div class="row">
                        <div class="col-lg-6 main-header">
                            <h2> <span> سرویس ها</span></h2>
                            <h6 class="mb-0">نمایش سرویس ها</h6>
                        </div>
                        <div class="col-lg-6 breadcrumb-right">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">نمایش سرویس ها</li>
                            </ol>
                        </div>
                    </div>
                </div>
                                ...
                                <table class="table">
                                    ...
                                    @foreach ($services as $key => $row )
                                        ...
                                        <tr>
                                            ...
                                            <th scope="row">{{++$key}}</th>
                                            <td> {{$row->title}} </td>
                                            <td> <img src="{{asset('uploads/service/'.$row->image)}}"  width="50" height="50" /> </td>
                                            <td> <a href="{{route('service.edit',$row->id)}}"><i class="fa fa-pencil-square-o text-primary" aria-hidden="true"></i></a></td>
                                            <td>

                                                    <button type="submit" style="border:0 solid black; background-color: transparent;" class="remove-service" data-action="{{route('service.delete',$row->id)}}"><i class="fa fa-trash-o text-danger" aria-hidden="true"></i></button>
...
<script type="text/javascript">
    $("body").on("click", ".remove-service", function () {
        ...
        swal({
            ...
            text: "آیا میخواهید این زیر سرویس رو حذف کنید",
            type: "error",
