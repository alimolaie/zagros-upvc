                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            ...
                            <form class="form theme-form" method="POST" action="{{ route('service.update',$service->id) }}" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input class="form-control" type="text" placeholder="لطفا عنوان را وارد کنید"  name="title" value="{{$service->title}}">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    ...
                                                    <br>
                                                    <img src="{{ asset('uploads/service/'.$service->image) }}" width="50" height="50">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
