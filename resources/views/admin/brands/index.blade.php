                ...
                <div class="page-header">
                    <div class="row">
                        <div class="col-lg-6 main-header">
                            <h2> <span> برند ها</span></h2>
                            <h6 class="mb-0">نمایش برند ها</h6>
                        </div>
                        <div class="col-lg-6 breadcrumb-right">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">نمایش برند ها</li>
                            </ol>
                        </div>
                    </div>
                </div>
                                ...
                                <table class="table">
                                    ...
                                    @foreach ($brands as $key => $row )
                                        ...
                                        <tr>
                                            ...
                                            <td> <img src="{{asset('uploads/brands/'.$row->image)}}"  width="50" height="50" /> </td>
                                            <td> <a href="{{route('brands.edit',$row->id)}}"><i class="fa fa-pencil-square-o text-primary" aria-hidden="true"></i></a></td>
                                            <td>

                                                <button type="submit" style="border:0 solid black; background-color: transparent;" class="remove-service" data-action="{{route('brand.delete',$row->id)}}"><i class="fa fa-trash-o text-danger" aria-hidden="true"></i></button>
...
<script type="text/javascript">
    $("body").on("click", ".remove-service", function () {
        ...
        swal({
            ...
            text: "آیا میخواهید این زیر برند رو حذف کنید",
            type: "error",
