                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            ...
                            <form class="form theme-form" method="POST" action="{{ route('brands.update',$brands->id) }}" enctype="multipart/form-data">
                                @csrf
                            @method("PUT")
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input class="form-control" type="text" placeholder="لطفا عنوان را وارد کنید"  name="title" value="{{$brands->title_brand}}">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    ...
                                                    <br>
                                                    <img src="{{ asset('uploads/brands/'.$brands->image) }}" width="50" height="50">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
