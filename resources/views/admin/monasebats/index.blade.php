            ...
            <div class="page-header">
              <div class="row">
                <div class="col-lg-6 main-header">
                  <h2> <span> مناسبت</span></h2>
                  <h6 class="mb-0">همه مناسبت ها </h6>
                </div>
                <div class="col-lg-6 breadcrumb-right">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.html"><i class="pe-7s-home"></i></a></li>
                    <li class="breadcrumb-item">پنل مدیریت</li>
                    <li class="breadcrumb-item">مناسبت</li>
                    <li class="breadcrumb-item active">همه مناسبت ها</li>
                  </ol>
                </div>
              </div>
            </div>
                      ...
                      <table class="table table-xl">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><img src="{{asset('uploads/monasebat/'.$row->image)}}" alt="image post" width="40" height="40"></td>
                            <td>
                                @can('monasebats-edit')


                                <a href="{{ route('monasebat.edit',$row->id) }}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                @endcan
                                @can('monasebats-delete')
                                <form action="{{ route('monasebat.destroy',$row->id) }}" method="POST">
                                ...
                                <button type="submit"><i class="fa fa-trash-o text-danger delete-confirm" aria-hidden="true" ></i></button>
                        @endcan
                            </form>
                            </td>
                          </tr>
