              ...
              <div class="row">
                ...
                <div class="col-lg-6 breadcrumb-right">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">ویرایش مناسبت</li>
                  </ol>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-sm-12">
                ...
                <div class="card">
                  ...
                  <form class="form theme-form" method="POST" action="{{ route('update.monasebat',$monaSebat->id) }}" enctype="multipart/form-data">
                      @csrf
                      ...
                      <div class="row">
                        <div class="col">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input class="form-control" type="text" placeholder="لطفا نام را وارد کنید" name="name" value="{{ $monaSebat->name }}">
                            </div>
                          </div>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input class="form-control-file" type="file" name="image">
                                <br>
                              <img src="{{asset('uploads/monasebat/'.$monaSebat->image)}}" alt="image post" width="80" height="80">
                            </div>
                          </div>
                        </div>
                      </div>
