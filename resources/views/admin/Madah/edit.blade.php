            ...
            <div class="row">
              <div class="col-sm-12">
                ...
                <div class="card">
                  ...
                  <form class="form theme-form" method="POST" action="{{ url('ya-zahra/mahdah/'.$madahs->id) }}" enctype="multipart/form-data">
                      @csrf
                      ...
                      <div class="row">
                        <div class="col">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input class="form-control" type="text" placeholder="لطفا نام را وارد کنید" value="{{ $madahs->name }}" name="name">
                            </div>
                          </div>
                          ...
                          <div class="form-group row">
                            <label class="col-sm-3 col-form-label">بیوگرافی</label>
                            <div class="col-sm-9">
                              <textarea class="form-control" rows="5" cols="5" placeholder="بیوگرافی" name="bio">{{ $madahs->bio }}</textarea>
                            </div>
                          </div>
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              ...
                              <br>
                              <img src="{{ asset('madah/'.$madahs->image) }}" width="50" height="50">
                            </div>
                          </div>
                        </div>
                      </div>
