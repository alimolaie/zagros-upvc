                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 breadcrumb-right">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item">هدر</li>
                                <li class="breadcrumb-item active">ویرایش هدر</li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            ...
                            <form class="form theme-form" method="POST" action="{{ url('admin/header/update') }}" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input class="form-control" type="text" placeholder="لطفا عنوان را وارد کنید" value="{{ $header->title }}" name="title">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <textarea class="form-control" rows="5" cols="5" placeholder="لطفا توضیحات را وارد کنید" name="description">{{ $header->description }}</textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    ...
                                                    <br>
                                                    <img src="{{ asset('uploads/headers/'.$header->image) }}" width="50" height="50">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
