                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h5>ویرایش کردن سرویس</h5>
                            </div>
                            <form class="form theme-form" method="POST" action="{{ route('glass.update',$glass->id) }}" enctype="multipart/form-data">
                                @csrf
                                @method("PUT")
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input class="form-control" type="text" placeholder="لطفا عنوان را وارد کنید"  name="title" value="{{$glass->title_glass}}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <footer class="footer">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <p class="pull-right mb-0">بومی شده با <i class="fa fa-heart"></i> توسط : <a href="https://www.rtl-theme.com/author/iman1300/">امیر محمد اسدی </a></p>
                    </div>
                </div>
            </div>
        </footer>
