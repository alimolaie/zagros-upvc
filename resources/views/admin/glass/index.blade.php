                                ...
                                <table class="table">
                                    ...
                                    @foreach ($glass as $key => $row )
                                        ...
                                        <tr>
                                            ...
                                            <th scope="row">{{++$key}}</th>
                                            <td> {{$row->title_glass}} </td>
                                            <td> <a href="{{route('glass.edit',$row->id)}}"><i class="fa fa-pencil-square-o text-primary" aria-hidden="true"></i></a></td>
                                            <td>

                                                <button type="submit" style="border:0 solid black; background-color: transparent;" class="remove-service" data-action="{{route('glass.delete',$row->id)}}"><i class="fa fa-trash-o text-danger" aria-hidden="true"></i></button>
