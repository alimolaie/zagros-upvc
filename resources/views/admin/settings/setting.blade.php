                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            ...
                            <form class="form theme-form" method="POST" action="{{ url('admin/setting/update') }}" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input class="form-control" type="text" placeholder="لطفا آدرس را وارد کنید" value="{{ $settings->address }}" name="address">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-sm-3 col-form-label">تلفن</label>
                                                <div class="col-sm-9">
                                                    <input class="form-control" type="text" placeholder="لطفا تلفن را وارد کنید" value="{{ $settings->phone }}" name="phone">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-sm-3 col-form-label">ایمیل</label>
                                                <div class="col-sm-9">
                                                    <input class="form-control" type="text" placeholder="لطفا ایمیل را وارد کنید" value="{{ $settings->email }}" name="email">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-sm-3 col-form-label">روز های کاری</label>
                                                <div class="col-sm-9">
                                                    <input class="form-control" type="text" placeholder="لطفا روز های کاری را وارد کنید" value="{{ $settings->work_day }}" name="work_day">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-sm-3 col-form-label">زمان های کاری</label>
                                                <div class="col-sm-9">
                                                    <input class="form-control" type="text" placeholder="لطفا ایمیل را وارد کنید" value="{{ $settings->work_time }}" name="work_time">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input class="form-control-file" type="file" name="logo" id="file">
                                                    <br>
                                                    <img src="{{ asset('uploads/settings/'.$settings->logo) }}" width="50" height="50">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-sm-3 col-form-label">ایکون</label>
                                                <div class="col-sm-9">
                                                    <input class="form-control-file" type="file" name="icon" id="file">
                                                    <br>
                                                    <img src="{{ asset('uploads/settings/'.$settings->icon) }}" width="50" height="50">
                                                </div>
                                            </div>
