                ...
                <div class="page-header">
                    <div class="row">
                        <div class="col-lg-6 main-header">
                            <h2> <span> پروفیل ها</span></h2>
                            <h6 class="mb-0">نمایش پروفیل ها</h6>
                        </div>
                        <div class="col-lg-6 breadcrumb-right">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="index.html"><i class="pe-7s-home"></i></a></li>
                                <li class="breadcrumb-item">پنل مدیریت</li>
                                <li class="breadcrumb-item">پروفیل ها</li>
                                <li class="breadcrumb-item active">نمایش پروفیل ها</li>
                            </ol>
                        </div>
                    </div>
                </div>
                                ...
                                <table class="table">
                                    ...
                                    @foreach ($profile as $key => $row )
                                        ...
                                        <tr>
                                            ...
                                            <th scope="row">{{++$key}}</th>
                                            <td> {{$row->title_profile}} </td>
                                            <td> <a href="{{route('profile.edit',$row->id)}}"><i class="fa fa-pencil-square-o text-primary" aria-hidden="true"></i></a></td>
                                            <td>

                                                <button type="submit" style="border:0 solid black; background-color: transparent;" class="remove-service" data-action="{{route('profile.delete',$row->id)}}"><i class="fa fa-trash-o text-danger" aria-hidden="true"></i></button>
...
<script type="text/javascript">
    $("body").on("click", ".remove-service", function () {
        ...
        swal({
            ...
            text: "آیا میخواهید این زیر پروفیل رو حذف کنید",
            type: "error",
