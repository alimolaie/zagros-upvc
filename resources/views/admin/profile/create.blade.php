                ...
                <div class="page-header">
                    <div class="row">
                        <div class="col-lg-6 main-header">
                            <h2> <span> شیشه</span></h2>
                            <h6 class="mb-0">اضافه کردن </h6>
                        </div>
                        <div class="col-lg-6 breadcrumb-right">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="index.html"><i class="pe-7s-home"></i></a></li>
                                <li class="breadcrumb-item">پنل مدیریت</li>
                                <li class="breadcrumb-item">شیشه</li>
                                <li class="breadcrumb-item active">اضافه کردن شیشه</li>
                            </ol>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h5>اضافه کردن شیشه</h5>
                            </div>
                            <form class="form theme-form" method="POST" action="{{ route('profile.store') }}" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input class="form-control" type="text" placeholder="لطفا عنوان را وارد کنید"  name="title">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
